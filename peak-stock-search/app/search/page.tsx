    ...
    return (
        <div className="bg-lightBlue flex sm:flex-row flex-col justify-start">
            ...
            <div className="group sm:w-full flex flex-col items-center space-y-12 max-h-screen overflow-auto pb-8">
                ...
                <div className="group-[:focus-within]:blur-smtransition-opacity duration-1000 space-y-12 group-has-[:focus]:opacity-50 group-has-[:focus]:blur-sm  w-full sm:px-16 px-4 flex flex-col items-center">
